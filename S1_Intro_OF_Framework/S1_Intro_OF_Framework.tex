...
\begin{lstlisting}[style=terminal] 
	foramMonitor postProcessing/inletAveragePressure/0.3/surfaceFieldValue.dat
\end{lstlisting}
...
In the last section we have seen how to monitor residuals from the log file. 
